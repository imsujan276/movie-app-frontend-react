...
export default class App extends Component {
  ...
  handleJwtChange = (jwt) => this.setState({ jwt:jwt})
            ...
            <div className='col-md-10'>
                <Switch>
                  ...
                  <Route 
                    path="/admin/movie/:id" 
                    component={(props) => (
                      <AddMovie  {...props} jwt={this.state.jwt} handleJwtChange={this.handleJwtChange}/>
                    )} 
                  />
                  ...
                  <Route 
                    path="/admin" 
                    component={(props) => (
                      <Admin {...props} jwt={this.state.jwt} handleJwtChange={this.handleJwtChange}/>
                    )} 
                  />
